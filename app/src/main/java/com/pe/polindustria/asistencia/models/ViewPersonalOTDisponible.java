...
public class ViewPersonalOTDisponible {
    int id_personal;
    String nombre;
    String doc_ide;
    int tipo;
    ...
    String cliente;
    int estado;
    List<Asistencias> ingresos;

    public ViewPersonalOTDisponible(int id_personal, String nombre, String doc_ide, int tipo, int id_ot, String nro_orden, String producto_fabricar, String cliente, int estado, List<Asistencias> ingresos) {
    ...
    public List<Asistencias> getIngresos() {
        return ingresos;
    }

    public void setIngresos(List<Asistencias> ingresos) {
        this.ingresos = ingresos;
    }
}
